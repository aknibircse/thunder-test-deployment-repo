    ...
    <div className=" max-w-[1800px] mx-auto xl:px-20 md:px-10 sm:px-2 px-4 my-20 mt-40">
      ...
      <div className="lg:flex justify-between items-center mb-20">
        ...
        <div className="flex-1 text-white px-6">
          ...
          <p className="mb-20 lg:mb-10 text-lg">
        ...
        <div className="lg:flex-1 relative">
          <div className="flex justify-center items-center">
            <img
              src={img1}
              className="mr-20 md:mr-40 w-[141.781px] h-[188.45px] lg:w-[240px] lg:h-[296px]"
              alt=""
            />
            <img
              src={img2}
              className="absolute w-[184.906px] h-[249.298px] lg:w-[313px] lg:h-[422px]"
              alt=""
            />
            <img
              src={img3}
              className="w-[141.781px] h-[188.45px]  lg:w-[240px] lg:h-[319px]"
              alt=""
            />
          </div>
        </div>
