...
const Who = () => {
  return (
    <div>
      ...
      {/* responsive screen */}
      <div
        className="lg:hidden hero md:h-[100vh] md:max-w-[1500px] mx-auto mt-20"
        style={{
...
<p className="text-xs">
            ...
            <p className="text-xs">
              At Thunderslab, we specialize in comprehensive game testing
              services, ensuring each release meets the highest standards of
              quality. With over 2 years of invaluable experience, our dedicated
              team meticulously hunts down every bug, enhancing gameplay and
              user experience.
            </p>
</div>
            {/* flex description */}
            <div className="grid grid-cols-2 gap-10 text-start mt-2">
              ...
              <div>
                <p className="text-2xl mb-3">25+</p>
                <p className="text-xs">
                  Premium high-configuration devices for comprehensive testing
                </p>
              ...
              <div className="flex-1 relative">
                <div className="flex justify-center items-center">
                  ...
                  <div className="flex-1">
                    ...
                    <img
                      src={p3}
                      className="w-[101.38px] h-[114.936px] mx-3 my-5"
                      alt=""
                    />
                  </div>
                </div>
                {/* card */}
                <div className="absolute -mt-[260px] ml-24">
                 <div
                    className=" p-[10px]"
                    style={{
                      backgroundImage: `url('${whiteBorder}')`,
